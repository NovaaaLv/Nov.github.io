...
<html lang="en">
  ...
  <body>
      ...
      <div class="collapse bg-dark" id="navbarHeader">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-4 offset-md-1 py-4">
              <h4 class="text-white"><a href="create.php" class="btn btn-success">Upload</a></h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card shadow-sm" style="padding: 2px;">
          ...
          <div class="card-body z-index-2">
            <p class="card-text text-end" style="margin-top: 5px;"><?php echo $row['namaGame'] ?></p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button class="btn btn-sm btn-outline-secondary" onclick="popOne('<?php echo $row['thumbnailGame']; ?>', '<?php echo $row['deskGame']; ?>', '<?php echo $row['namaGame']; ?>', '<?php echo $row['harga']; ?>')">Order</button>
                <div class="hover-text text-start"><?php echo $row['deskGame'] ?></div>
                <div class="tombol" style="display: flex; gap:2px">
                  <a href="update.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary mt-2 rounded-1">Change</a>
                  <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger mt-2 rounded-1">Delete</a>
                </div>
    ...
    <footer class="text-muted p-5 bg-dark" style="margin-top:62px">
